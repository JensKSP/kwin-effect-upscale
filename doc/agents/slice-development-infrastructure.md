...
This is the next implementation slice, as requested on 2026-09-18. Its single
topic is making the current effect identifiable and observable during
development: About/build identity and notices, logging, and the shared passive
OSD with developer information. Complete it before starting further feature
slices. Existing rendering and pipeline acceptance records remain open until
their own gates pass; their outstanding work is not absorbed into this slice.
